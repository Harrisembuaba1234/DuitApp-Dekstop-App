 ...
 * @author user
 */
public class Pmbl_thn extends javax.swing.JFrame {

    /**
     * Creates new form Pmbl_thn
     */
    public Pmbl_thn() {
        initComponents();
        tampil ();
    ...
    private void total(){
        ...
        try {
            String sql = "SELECT SUM(sub_total) FROM pembelian join detail_beli "
                    ...
                    + " where year(tgl_pembelian)='"+txtTahun.getYear()+"'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Tahunan Pembelian");
        jPanel1.add(jLabel1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            try {
                ...
                String report = ("C:\\Dev\\Tutorial java\\Kasir\\src\\toko\\Pmbl_thn.jrxml");

                HashMap hash = new HashMap();
                //String, Object> hush = new HashMap()<String, object>();
                hash.put("Par_thn", txtTahun.getYear());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pmbl_thn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
